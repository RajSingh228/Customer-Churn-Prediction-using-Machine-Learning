# -*- coding: utf-8 -*-
"""adaboost_customerChurn.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/163bx_Uz4VQcIl1AeuvZKEah3YrMhSt1z
...
# Individual models hybrid model
...
# Add hybrid model to models dictionary
models["Hybrid Model"] = hybrid_model

# dictionary to store the cross validation results with hybrid
cv_scores = {}
